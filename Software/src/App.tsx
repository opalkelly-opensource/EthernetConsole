...
import { Application } from "./frontpanel-components";
...
const initializeDevice = async (
    ...
    const device = await deviceManager.openDevice(serialNumber);
...
function App() {
    ...
    React.useEffect(() => {
        ...
        DeviceWorkQueue.post(async () => {
            try {
                device = await initializeDevice(targetDeviceSerialNumber, "XEM8320-AU25P/EthernetConsole.bit");
